        ...
        <>
            ...
            <section className='mt-5'>
                ...
                <div className="mx-auto grid max-w-screen-2xl grid-cols-1 md:grid-cols-2">
                    <div className="bg-[#F5EBEB] py-12 md:py-24 order-2">
                                ...
                                <div className="flow-root">
                                    <ul className="-my-4 divide-y divide-gray-100">
                                        <li className="flex items-center gap-4 py-4">
                                            <img
                                                src="https://www.creativeideas.store/media/catalog/product/cache/f7fe0c39a88bd276837542f863d0cbe2/c/r/creativeideas.store_merchandise_pantone-black-black-notebook-lifestyle-01.jpg"
                                                alt=""
                                                className="h-20 w-20 rounded object-cover"
                                            />

                                            <div>
                                                <h3 className="text-xl font-semibold text-gray-900">Basic Tee 6-Pack</h3>
                                        ...
                                        <li className="flex items-center gap-4 py-4">
                                            <img
                                                src="https://ae01.alicdn.com/kf/Sf4ec6dd691ba478a8f64d75d67cd3a2eQ/Arrtx-Artist-72-Colored-Pencils-Set-with-Protective-Vertical-Insert-Box-Organizer-Premium-Soft-Leads-Bright.jpg_Q90.jpg_.webp"
                                                alt=""
                                                className="h-20 w-20 rounded object-cover"
                                            />
                                        ...
                                        <li className="flex items-center gap-4 py-4">
                                            <img
                                                src="https://www.arageek.com/wp-content/uploads/2021/04/letter-file-desktop-organizer-1.jpg"
                                                alt=""
                                                className="h-20 w-20 rounded object-cover"
                                            />
                    ...
                    <div className="bg-white py-12 md:py-24 order-1">
                        <div className="mx-auto max-w-lg px-4 lg:px-8">
                            <form className="grid grid-cols-6 gap-4">
                                ...
                                <div className="col-span-6">
                                    <button
                                        className="block w-full rounded-md bg-[#867070] p-2.5 text-sm text-white transition hover:shadow-lg"
                                    >
                                        Pay Now
                                    </button>
                                </div>
